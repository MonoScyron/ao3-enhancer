...
(function() {
    ...
    // Settings icon & dropdown text
    var settingsIcon = document.createElementNS(
        "http:// www.w3.org/2000/svg",
        "svg"
    );
    settingsIcon.id = "settings-icon";
    settingsIcon.setAttributeNS(null, "fill", "currentColor");
    settingsIcon.setAttributeNS(null, "viewbox", "0 0 1.286em 1.286em");
    settingsIcon.setAttributeNS(null, "width", "1.286em");
    settingsIcon.setAttributeNS(null, "height", "1.286em");
    var settingsIconPath = document.createElementNS(
        "http:// www.w3.org/2000/svg",
        "path"
    );
    settingsIconPath.setAttributeNS(
        null,
        "d",
