...
export const FILTER_HTML = `<form class="narrow-hidden filters" id="work-filters" action="/works" accept-charset="UTF-8" method="get">
    ...
    <dl>
        ...
        <dd class="sort">
            <select name="work_search[sort_column]" id="work_search_sort_column">
                ...
                <option selected="selected" value="last_visited">Last Visited</option>
